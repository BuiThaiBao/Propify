          ...
          <div v-else class="popup-body">
            ...
            <div class="form-fields">
              ...
              <div class="input-group" :class="{ 'has-error': phoneError }">
                ...
                <input v-model="form.phone" type="tel" placeholder="Số điện thoại *" @input="onPhoneInput" @blur="validatePhone(true)" />
              </div>
              ...
              <div class="input-group" :class="{ 'has-error': emailError }">
                ...
                <input v-model="form.email" type="email" placeholder="Email *" @input="onEmailInput" @blur="validateEmail(true)" />
              </div>
