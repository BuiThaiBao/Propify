    ...
    <div class="max-w-7xl mx-auto px-4 md:px-8 py-8">
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-9">
          <!-- Breadcrumb -->
          <Breadcrumb
            :crumbs="[{ label: 'Trang chủ', to: '/' }, { label: 'Mua bán' }]"
          />
            ...
            <div>
              ...
              <p class="text-sm text-gray-500">
                ...
                <span class="font-bold text-blue-600">{{
                  saleTotal ? Number(saleTotal).toLocaleString("vi-VN") : 0
                }}</span>
                bất động sản.
              </p>
            </div>
          ...
          <div class="relative flex flex-col gap-6">
            ...
            <div
              v-if="saleLoading && saleListings.length > 0"
            ...
            <div
              v-else-if="!saleLoading && saleListings.length === 0"
            ...
            <div class="flex flex-col gap-1.5">
              ...
              >
                ...
                <span
                  class="text-sm transition-colors"
                  :class="{
                    'font-semibold': selectedPricePreset === 'under_2',
                  }"
                  >Dưới 2 tỷ</span
                >
              </label>
              ...
              >
                ...
                <span
                  class="text-sm transition-colors"
                  :class="{ 'font-semibold': selectedPricePreset === '2_5' }"
                  >2 - 5 tỷ</span
                >
              </label>
              <label
              ...
              >
                ...
                <span
                  class="text-sm transition-colors"
                  :class="{ 'font-semibold': selectedPricePreset === '5_10' }"
                  >5 - 10 tỷ</span
                >
              </label>
              <label
              ...
              >
                ...
                <span
                  class="text-sm transition-colors"
                  :class="{ 'font-semibold': selectedPricePreset === '10_20' }"
                  >10 - 20 tỷ</span
                >
              </label>
              <label
              ...
              >
                ...
                <span
                  class="text-sm transition-colors"
                  :class="{ 'font-semibold': selectedPricePreset === '20_50' }"
                  >20 - 50 tỷ</span
                >
              </label>
...
const {
  ...
  onSearch,
  goToPage,
} = usePublicListings({ demandType: "SALE" });
const { init: prefetchHomeListings } = useHomeListings();
const { init: prefetchRentListings } = usePublicListings({
  demandType: "RENT",
});
...
function updateCustomPrice() {
  ...
  priceDebounce = setTimeout(() => {
    if (selectedPricePreset.value === "custom") {
      const minVal =
        minPriceInput.value !== ""
          ? Number(minPriceInput.value) * 1000000000
          : null;
      const maxVal =
        maxPriceInput.value !== ""
          ? Number(maxPriceInput.value) * 1000000000
          : null;
