...
- **[🎓 Báo cáo Bảo vệ Đồ án](bao_cao_bao_ve_do_an.md)** - FILE CHÍNH TRÌNH BÀY VỚI GIẢNG VIÊN: Phân tích theo từng chức năng nghiệp vụ (Đăng ký, Đăng nhập, Nâng cấp tin, Filter Sorting, Chat), giải thích lý do chọn pattern và code triển khai chi tiết.
