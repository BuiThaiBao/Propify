...
final class EloquentListingRepository implements ListingRepository
{
    ...
    public function paginatePublic(
        ...
        $query = Listing::query()
            ...
            ->with([
                'property:id,type,province_code,ward_code,street_code,project_name,address_detail,area,price,bedrooms,bathrooms,contact_name,contact_phone,contact_email,poster_type,lat,lng',
